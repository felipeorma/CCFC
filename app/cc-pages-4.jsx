...
function EstadoLogos() {
  const [, setTick] = p4State(0);
  const [eqSel, setEqSel] = p4State('Curicó Unido');
  const [url, setUrl] = p4State('');
  ...
  return (
    <Card className="cc-pad">
      ...
      <p className="cc-card-note">Los escudos se obtienen desde la CDN de Sofascore. Si alguno no aparece, selecciónalo abajo y pega la URL de su imagen para corregirlo manualmente.</p>
      ...
      <form className="cc-logo-manual" onSubmit={guardarLogo}>
        ...
        <label className="cc-select-wrap" style={{ flex: 1, minWidth: '260px' }}>
          ...
          <input
            ...
            placeholder="Ej: https://img.sofascore.com/api/v1/team/33595/image"
          ></input>
        </label>
