...
function PageCompEquipos() {
  ...
  return (
    <div className="cc-page">
      <PageHeader icon="compEquipos" title="Comparación de Equipos" subtitle="Cara a cara con promedios Wyscout · los rivales reflejan sus partidos vs Colo-Colo"></PageHeader>
...
function PageDispEquipos() {
  ...
  return (
    <div className="cc-page">
      <PageHeader icon="dispEq" title="Dispersión · Equipos" subtitle="Equipos con datos Wyscout · Colo-Colo destacado · rivales según sus partidos vs CC"></PageHeader>
      <Card className="cc-pad cc-filters">
      ...
      <Card className="cc-pad">
        ...
        <p className="cc-card-note">Cada rival refleja únicamente su rendimiento contra Colo-Colo. Sube más archivos Team Stats en Configuración para una comparación de temporada completa.</p>
      </Card>
    </div>
  );
}
