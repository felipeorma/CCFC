  ...
  <div className="cc-page" id="cc-comp-equipos-cap">
   ...
   <Card className="cc-pad cc-h2h">
    <div className="cc-h2h-team">
     ...
     <strong>{eqA}</strong>
     {dA._pj != null && <span className="cc-h2h-pj">{dA._pj} {dA._pj === 1 ? 'partido' : 'partidos'} jugados</span>}
    ...
    <div className="cc-h2h-team">
     ...
     <strong>{eqB}</strong>
     {dB._pj != null && <span className="cc-h2h-pj">{dB._pj} {dB._pj === 1 ? 'partido' : 'partidos'} jugados</span>}
   ...
   <div className="cc-grid-2 cc-comp-cuerpo">
    <Card className="cc-pad">
     ...
     <p className="cc-card-note">{fuenteB ? 'Rival: ' + fuenteB.replace(/\s*·?\s*/i, '').trim() + '. ' : ''}En PPDA y goles en contra, el valor más bajo indica mejor rendimiento.</p>
    </Card>
  ...
  <div className="cc-page" id="cc-comp-jugadores-cap">
   ...
   <Card className="cc-pvp">
    <div className="cc-pvp-hero">
     <div className="cc-pvp-side">
      <CCTeamLogo team={a.equipo} size={46}></CCTeamLogo>
      <div className="cc-pvp-id">
       <strong>{a.nombre}</strong>
       <span>{a.posicion} · {a.edad} años · {a.equipo}</span>
       <span className="cc-pvp-min">{a.min}' · {a.pj} PJ</span>
      </div>
     </div>
     <div className="cc-pvp-vs">VS</div>
     <div className="cc-pvp-side der">
      <div className="cc-pvp-id der">
       <strong>{b.nombre}</strong>
       <span>{b.posicion} · {b.edad} años · {b.equipo}</span>
       <span className="cc-pvp-min">{b.min}' · {b.pj} PJ</span>
      </div>
      <CCTeamLogo team={b.equipo} size={46}></CCTeamLogo>
     </div>
    </div>
    <div className="cc-pvp-selects">
...
function PageDispEquipos() {
 ...
 return (
  <div className="cc-page" id="cc-disp-eq-cap">
   <PageHeader icon="dispEq" title="Dispersión · Equipos" subtitle="Equipos con datos Wyscout de temporada completa · Colo-Colo destacado"
    right={<ExportJPGButton targetSelector="#cc-disp-eq-cap" filename="dispersion-equipos" titulo="Dispersión de Equipos"></ExportJPGButton>}></PageHeader>
   <Card className="cc-pad cc-filters">
